...
<div class="row">
    <div class="col-12 col-lg-8">
       ...
       id="files" name="files[]" accept="image/*,video/*" multiple onchange="previewImages(event)">
...
function previewImages(event) {
    ...
    if (event.target.files) {
        // Ubah list file menjadi array untuk di-looping
        Array.from(event.target.files).forEach(file => {
            ...
            reader.onload = function(e) {
                ...
                if (file.type.startsWith('image/')) {
                    div.innerHTML = `<img src="${e.target.result}" class="img-thumbnail" style="width: 120px; height: 120px; object-fit: cover;">`;
                } 
                // Cek jika file adalah video
                else {
                    div.innerHTML = `<div class="img-thumbnail d-flex align-items-center justify-content-center bg-light" style="width: 120px; height: 120px;">
