    ...
    <div class="col-12 col-lg-8 mb-4">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <h6 class="mb-3">Peraturan Stok Manual</h6>
                    <form action="{{ route('admin.ingredients.updateStock', $ingredient) }}" method="POST" class="row g-2 g-md-3">
                        ...
                        <div class="col-12 col-md-4">
                            <input type="number" name="quantity" class="form-control form-control-sm" placeholder="Jumlah" min="1" required>
                        </div>
                        ...
                        <div class="col-12">
                            <textarea name="description" class="form-control form-control-sm" placeholder="Keterangan (opsional)" rows="2"></textarea>
                        </div>
                    </form>
                </div>
            </div>
