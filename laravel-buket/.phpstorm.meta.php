...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\buket.cute\laravel-buket\public\storage' => 'string',
            ...
            'logging.channels.whatsapp.driver' => 'string',
            'logging.channels.whatsapp.path' => 'string',
            'logging.channels.whatsapp.level' => 'string',
            'logging.channels.whatsapp.replace_placeholders' => 'boolean',
            'mail.default' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.D:\\buket.cute\\laravel-buket\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'logging.channels.emergency.path','logging.channels.whatsapp.driver','logging.channels.whatsapp.path','logging.channels.whatsapp.level','logging.channels.whatsapp.replace_placeholders',
...
'whatsapp.webhook','whatsapp.webhook-test','whatsapp.status','whatsapp.send-text','whatsapp.send-media',
'whatsapp.conversations','whatsapp.conversation-messages','whatsapp.customer-conversation','fuzzy-rules.index','fuzzy-rules.store',
'fuzzy-rules.stats','fuzzy-rules.test','fuzzy-rules.import','fuzzy-rules.show','fuzzy-rules.update',
'fuzzy-rules.destroy','public.home','public.catalog','public.detail',
'public.about','public.contact','public.faq','public.customRequest','public.submitCustomRequest',
'public.orderToWhatsApp','media.show','dashboard','admin.categories.index','admin.categories.create',
...
'admin.products.update','admin.products.destroy','admin.products.updateStock','admin.ingredients.index','admin.ingredients.create',
'admin.ingredients.store','admin.ingredients.show','admin.ingredients.edit','admin.ingredients.update','admin.ingredients.destroy',
'admin.ingredients.updateStock','admin.purchases.index','admin.purchases.create','admin.purchases.store','admin.purchases.show',
'admin.purchases.edit','admin.purchases.update','admin.purchases.destroy','admin.customers.index','admin.customers.create',
'admin.customers.store','admin.customers.show','admin.customers.edit','admin.customers.update','admin.customers.destroy',
'admin.customers.show-by-phone','admin.orders.index','admin.orders.create','admin.orders.store','admin.orders.show',
'admin.orders.edit','admin.orders.update','admin.orders.destroy','admin.orders.updateStatus','admin.chat.index',
'admin.chat.show','admin.chat.destroy','admin.chat.send','admin.chat.updateStatus','admin.messages.mark-read',
'admin.chat.stats','admin.reports.sales','admin.reports.stock','admin.reports.chat','admin.reports.export-sales',
'admin.fuzzy-rules.index','admin.fuzzy-rules.create','admin.fuzzy-rules.store','admin.fuzzy-rules.show','admin.fuzzy-rules.edit',
'admin.fuzzy-rules.update','admin.fuzzy-rules.destroy','admin.fuzzy-rules.toggle','admin.fuzzy-rules.test-pattern','admin.fuzzy-rules.import-form',
'admin.fuzzy-rules.import','admin.fuzzy-rules.export','admin.settings.index','admin.settings.update','admin.settings.whatsapp-status',
'admin.settings.rescan-qr','login','password.request','password.email',
...
'admin.categories.create','admin.categories.edit','admin.categories.index','admin.categories.show','admin.chat.index',
'admin.chat.show','admin.chat.show-improved','admin.customers.create','admin.customers.edit','admin.customers.index',
'admin.customers.show','admin.fuzzy-rules.create','admin.fuzzy-rules.edit','admin.fuzzy-rules.import','admin.fuzzy-rules.index',
'admin.fuzzy-rules.show','admin.ingredients.create','admin.ingredients.edit','admin.ingredients.index','admin.ingredients.show',
'admin.orders.create','admin.orders.edit','admin.orders.index','admin.orders.show','admin.products.create',
'admin.products.edit','admin.products.index','admin.products.show','admin.purchases.create','admin.purchases.edit',
'admin.purchases.index','admin.purchases.show','admin.reports.chat','admin.reports.export-sales','admin.reports.sales',
'admin.reports.stock','admin.settings.index','auth.confirm-password','auth.forgot-password','auth.login',
...
'layouts.navigation','layouts.public','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','public.about','public.catalog','public.contact','public.custom-request',
'public.faq','public.home','public.product-detail','welcome','laravel-exceptions-renderer::components.badge',
...
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.buket.cute.laravel-buket.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','STORE_WHATSAPP','WHATSAPP_SERVICE_URL',
'WHATSAPP_API_KEY','WHATSAPP_WEBHOOK_KEY','WHATSAPP_BUSINESS_PHONE','LOG_WHATSAPP_CHANNEL','STORE_WHATSAPP',
'WHATSAPP_SERVICE_URL','WHATSAPP_API_KEY','WHATSAPP_WEBHOOK_KEY','WHATSAPP_BUSINESS_PHONE','LOG_WHATSAPP_CHANNEL',
'MAIL_SCHEME','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION',
